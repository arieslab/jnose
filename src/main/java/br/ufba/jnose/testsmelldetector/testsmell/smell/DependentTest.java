package br.ufba.jnose.testsmelldetector.testsmell.smell;
...
import br.ufba.jnose.testsmelldetector.testsmell.SmellyElement;
import br.ufba.jnose.testsmelldetector.testsmell.Util;
    ...
    public void runAnalysis(CompilationUnit testFileCompilationUnit, CompilationUnit productionFileCompilationUnit,
        ...
        for (TestMethod testMethod : testMethods) {
            if (testMethod.getCalledMethods().stream().anyMatch(x -> x.getName()
                ...
                smellyElementList.add(new br.ufba.jnose.testsmelldetector.testsmell.TestMethod(
