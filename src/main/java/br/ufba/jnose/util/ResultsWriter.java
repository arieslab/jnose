...
public class ResultsWriter {
     ...
     * @throws IOException
     */
    private ResultsWriter(String outputFile) throws IOException {
        this.outputFile = outputFile;
        writer = new FileWriter(outputFile,false);
    }

    /**
     * Factory method that provides a new instance of the br.ufba.testfiledetector.ResultsWriter
     * @return new br.ufba.testfiledetector.ResultsWriter instance
     * @throws IOException
     */
    public static ResultsWriter createResultsWriter(String outputFile) throws IOException {
