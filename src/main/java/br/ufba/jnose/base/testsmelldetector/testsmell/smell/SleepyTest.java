 ...
 */
public class SleepyTest extends br.ufba.jnose.base.testsmelldetector.testsmell.AbstractSmell {

    private ArrayList<br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage> spleepyInstance;
    ...
    public void runAnalysis(CompilationUnit testFileCompilationUnit, CompilationUnit productionFileCompilationUnit, String testFileName, String productionFileName) throws FileNotFoundException {
        ...
        for (br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage method : spleepyInstance) {
                ...
                if (n.getNameAsString().equals("sleep")) {
                    ...
                    if ((n.getScope().isPresent() && n.getScope().get() instanceof NameExpr)) {
                        ...
                        if ((((NameExpr) n.getScope().get()).getNameAsString().equals("Thread"))) {
                            sleepCount++;
                            spleepyInstance.add(new br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage(currentMethod.getNameAsString(), "", String.valueOf(n.getRange().get().begin.line), String.valueOf(n.getRange().get().begin.line)));
                        }
                    }
                }
            }
