 ...
 */
public class MysteryGuest extends br.ufba.jnose.base.testsmelldetector.testsmell.AbstractSmell {

    private ArrayList<br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage> mysteryInstance;
    ...
    public void runAnalysis(CompilationUnit testFileCompilationUnit, CompilationUnit productionFileCompilationUnit, String testFileName, String productionFileName) throws FileNotFoundException {
        ...
        for (br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage method : mysteryInstance) {
            ...
            if (currentMethod != null) {
                for (String variableType : mysteryTypes) {
                    ...
                    if ((n.getVariable(0).getType().asString().equals(variableType))) {
                        ...
                        mysteryCount++;
                        mysteryInstance.add(new br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage(currentMethod.getNameAsString(), "",
