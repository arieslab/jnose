...
public class GeneralFixture extends br.ufba.jnose.base.testsmelldetector.testsmell.AbstractSmell {

    List<MethodDeclaration> methodList;
    MethodDeclaration setupMethod;
    List<FieldDeclaration> fieldList;
    List<br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage> setupFields;
    br.ufba.jnose.base.testsmelldetector.testsmell.TestMethod testMethod;
    private List<br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage> instaceGeneral;
    ...
    public void runAnalysis(CompilationUnit testFileCompilationUnit, CompilationUnit productionFileCompilationUnit, String testFileName, String productionFileName) throws FileNotFoundException {
                        ...
                        if (nodeList.get(i) instanceof ExpressionStmt) {
                            ...
                            if (expressionStmt.getExpression() instanceof AssignExpr) {
                                ...
                                if (fieldList.get(j).getVariable(k).getNameAsString().equals(assignExpr.getTarget().toString())) {
                                    setupFields.add(new br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage(setupMethod.getNameAsString(),
        ...
        for (br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage method : instaceGeneral) {
    ...
    private class ClassVisitor extends VoidVisitorAdapter<Void> {
        ...
        public void visit(ClassOrInterfaceDeclaration n, Void arg) {
            ...
            for (int i = 0; i < members.size(); i++) {
                if (members.get(i) instanceof MethodDeclaration) {
                    ...
                    if (br.ufba.jnose.base.testsmelldetector.testsmell.Util.isValidTestMethod(methodDeclaration)) {
                        methodList.add(methodDeclaration);
                    }

                    //Get the setup method
                    if (br.ufba.jnose.base.testsmelldetector.testsmell.Util.isValidSetupMethod(methodDeclaration)) {
        ...
        public void visit(MethodDeclaration n, Void arg) {
            if (br.ufba.jnose.base.testsmelldetector.testsmell.Util.isValidTestMethod(n)) {
                ...
                for (br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage field : setupFields){
