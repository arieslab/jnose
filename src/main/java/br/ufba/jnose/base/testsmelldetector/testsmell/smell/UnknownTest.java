...
public class UnknownTest extends br.ufba.jnose.base.testsmelldetector.testsmell.AbstractSmell {

    private ArrayList<br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage> instanceUnkNown;
    ...
    public void runAnalysis(CompilationUnit testFileCompilationUnit, CompilationUnit productionFileCompilationUnit, String testFileName, String productionFileName) throws FileNotFoundException {
        ...
        for (br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage method : instanceUnkNown) {
        ...
        public void visit(MethodDeclaration n, Void arg) {
            if (br.ufba.jnose.base.testsmelldetector.testsmell.Util.isValidTestMethod(n)) {
                ...
                if (!hasAssert && !hasExceptionAnnotation)
                    instanceUnkNown.add(new br.ufba.jnose.base.testsmelldetector.testsmell.MethodUsage(n.getNameAsString(), "",
