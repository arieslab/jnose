...
public class ResultPage extends ImprimirPage {
    ...
    public ResultPage(List<List<String>> todasLinhas, String title, String csvFileName, boolean fontColorized) {
        this(todasLinhas, title, csvFileName, fontColorized, null);
    }

    public ResultPage(List<List<String>> todasLinhas, String title, String csvFileName, boolean fontColorized, String coverageCsvPath) {
        ...
        DownloadLink lkCoverageCSV;
        if (coverageCsvPath != null && new File(coverageCsvPath).exists()) {
            lkCoverageCSV = new DownloadLink("lkCoverageCSV", new File(coverageCsvPath));
        } else {
            lkCoverageCSV = new DownloadLink("lkCoverageCSV", new File(""));
            lkCoverageCSV.setVisible(false);
        }
        add(lkCoverageCSV);
